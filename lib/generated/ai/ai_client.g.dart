...
class _AiClient implements AiClient {
  _AiClient(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<WebSocketResponse> aiGenerativeMessageCreate({
    ...
    final _options = _setStreamType<WebSocketResponse>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/api/v1/ai/generative_message/',
    ...
    late WebSocketResponse _value;
    try {
      _value = WebSocketResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
